/*
  ...
  - You are about to drop the `Kategori_Wisata` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "Kategori_Wisata" DROP CONSTRAINT "Kategori_Wisata_userId_fkey";
